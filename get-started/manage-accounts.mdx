...
description: "You will need to create an account or get invited by a team member to use RunPod."
---
...
### Convert personal account to a team account[​](#convert-personal-account-to-a-team-account "Direct link to Convert personal account to a team account")
...
### Invite a user[​](#invite-a-user "Direct link to Invite a user")
...
## Role types[​](#role-types "Direct link to Role types")

The following roles and permissions are available to you:

### Basic role[​](#basic-role "Direct link to Basic role")
...
### Billing role[​](#billing-role "Direct link to Billing role")
...
### Dev role[​](#dev-role "Direct link to Dev role")
...
### Admin role[​](#admin-role "Direct link to Admin role")
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/get-started/manage-accounts.md)
