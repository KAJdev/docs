...
description: "All billing, including per-hour compute and storage billing, is charged per minute."
---
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/get-started/billing-information.md)
