---
title: "Burn Testing"
description: "Machines should be thoroughly tested before they are listed on the RunPod platform. Here is a simple guide to running a burn test for a few days."
---
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/hosting/burn-testing.md)
