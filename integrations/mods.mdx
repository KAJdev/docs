...
description: "Mods is an AI-powered tool designed for the command line and built to seamlessly integrate with pipelines. It provides a convenient way to interact with language models directly from your terminal."
---

## How Mods Works[​](#how-mods-works "Direct link to How Mods Works")
...
3. **Configure RunPod**:
   ...
   * Update the `config_template.yml` file to use your RunPod configuration. Here's an example:
     ...
     ```
     runpod:  # https://docs.runpod.io/serverless/workers/vllm/openai-compatibility  base-url: https://api.runpod.ai/v2/${YOUR_ENDPOINT}/openai/v1  api-key:  api-key-env: RUNPOD_API_KEY  models:    # Add your model name    openchat/openchat-3.5-1210:      aliases: ["openchat"]      max-input-chars: 8192
     ```
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/integrations/mods/mods.md)
