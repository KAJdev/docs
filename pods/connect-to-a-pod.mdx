...
description: "You can connect to a Pod through various methods, depending on your requirements, preferences, and templates used."
---

## SSH terminal[​](#ssh-terminal "Direct link to SSH terminal")
...
```
# No support for SCP & SFTPssh <username>@<pod-ssh-hostname> -i <path-to-ssh-key># Supports SCP & SFTPssh <username>@<pod-ip-address> -p <ssh-port> -i <path-to-ssh-key>
```
...
## Web terminal[​](#web-terminal "Direct link to Web terminal")
...
<Note>
  ...
  ![Username and password](/images/pods/assets/images/username-password-e56cf90a5083892db3bb69e6944fee81.png)
</Note>

[Edit this page](https://github.com/runpod/docs/blob/main/docs/pods/connect-to-a-pod.md)
