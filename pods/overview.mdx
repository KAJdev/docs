---
title: "Overview"
description: "Pods are running container instances. You can pull an instance from a container registry such as Docker Hub, GitHub Container Registry, Amazon Elastic Container Registry, or another compatible registry."
---
...
### Understanding Pod components and configuration[​](#understanding-pod-components-and-configuration "Direct link to Understanding Pod components and configuration")
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/pods/overview.md)
