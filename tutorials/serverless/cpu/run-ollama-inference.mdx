...
description: "In this guide, you will learn how to run an Ollama server on your RunPod CPU for inference. Although this tutorial focuses on CPU compute, you can also select a GPU type and follow the same steps. By the end of this tutorial, you will have a fully functioning Ollama server ready to handle requests."
---

## Setting up your Endpoint[​](#setting-up-your-endpoint "Direct link to Setting up your Endpoint")
...
## Sending a Run request[​](#sending-a-run-request "Direct link to Sending a Run request")
...
2. In the input module, enter the following JSON object:
   ...
   ```
   {  "input": {    "method_name": "generate",    "input": {      "prompt": "why the sky is blue?"    }  }}
   ```
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/tutorials/serverless/cpu/run-ollama-inference.md)
