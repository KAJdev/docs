...
## Create a Pod instance[​](#create-a-pod-instance "Direct link to Create a Pod instance")
...
## Establish a connection[​](#establish-a-connection "Direct link to Establish a connection")
...
## Configuring VSCode for remote development[​](#configuring-vscode-for-remote-development "Direct link to Configuring VSCode for remote development")
...
4. Update your `.ssh/config` file by saving the configuration. For example:
   ...
   ```
   Host your_pod_instance    HostName 123.456.789.80    User root    Port 12345    IdentityFile ~/.ssh/id_ed12345
   ```
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/tutorials/pods/connect-to-vscode.md)
