...
```
!pip install pygit2==1.12.2!pip install opencv-python==4.9.0.80%cd /workspace!git clone https://github.com/lllyasviel/Fooocus.git%cd /workspace/Fooocus!python entry_with_update.py --share
```

## Launch UI[​](#launch-ui "Direct link to Launch UI")
...
## Explore the model[​](#explore-the-model "Direct link to Explore the model")

Explore and run the model.

[Edit this page](https://github.com/runpod/docs/blob/main/docs/tutorials/pods/run-fooocus.md)
