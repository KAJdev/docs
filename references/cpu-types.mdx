...
description: "The following list contains all CPU types available on RunPod."
---
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/references/cpu-types.md)
