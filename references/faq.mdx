...
## Secure Cloud vs Community Cloud[​](#secure-cloud-vs-community-cloud "Direct link to Secure Cloud vs Community Cloud")
...
## On-Demand vs. Spot Pod[​](#on-demand-vs-spot-pod "Direct link to On-Demand vs. Spot Pod")
...
### How does RunPod work?[​](#how-does-runpod-work "Direct link to How does RunPod work?")
...
### Where can I go for help?[​](#where-can-i-go-for-help "Direct link to Where can I go for help?")
...
### What is RunPod's policy on refunds and credits?[​](#what-is-runpods-policy-on-refunds-and-credits "Direct link to What is RunPod's policy on refunds and credits?")
...
## What are Pods?[​](#what-are-pods "Direct link to What are Pods?")

***

### What is an On-Demand instance?[​](#what-is-an-on-demand-instance "Direct link to What is an On-Demand instance?")
...
### What is a Spot instance?[​](#what-is-a-spot-instance "Direct link to What is a Spot instance?")
...
### What is a Savings Plan?[​](#what-is-a-savings-plan "Direct link to What is a Savings Plan?")
...
### How does Pod billing work?[​](#how-does-pod-billing-work "Direct link to How does Pod billing work?")
...
### How does storage billing work?[​](#how-does-storage-billing-work "Direct link to How does storage billing work?")
...
### How does Network Volume billing work?[​](#how-does-network-volume-billing-work "Direct link to How does Network Volume billing work?")
...
### Can I withdraw my unused balance?[​](#can-i-withdraw-my-unused-balance "Direct link to Can I withdraw my unused balance?")
...
### Is my data protected from other clients?[​](#is-my-data-protected-from-other-clients "Direct link to Is my data protected from other clients?")
...
### Is my data protected from the host of the machine my Pod is running on?[​](#is-my-data-protected-from-the-host-of-the-machine-my-pod-is-running-on "Direct link to Is my data protected from the host of the machine my Pod is running on?")
...
### What can I do in a RunPod Pod?[​](#what-can-i-do-in-a-runpod-pod "Direct link to What can I do in a RunPod Pod?")
...
### Can I run my own Docker daemon on RunPod?[​](#can-i-run-my-own-docker-daemon-on-runpod "Direct link to Can I run my own Docker daemon on RunPod?")
...
### My Pod is stuck on initializing. What gives?[​](#my-pod-is-stuck-on-initializing-what-gives "Direct link to My Pod is stuck on initializing. What gives?")
...
### Can I run Windows?[​](#can-i-run-windows "Direct link to Can I run Windows?")
...
### How do I find a reliable server in Community Cloud?[​](#how-do-i-find-a-reliable-server-in-community-cloud "Direct link to How do I find a reliable server in Community Cloud?")
...
### Why do I have zero GPUs assigned to my Pod?[​](#why-do-i-have-zero-gpus-assigned-to-my-pod "Direct link to Why do I have zero GPUs assigned to my Pod?")
...
#### What are Network Volumes?[​](#what-are-network-volumes "Direct link to What are Network Volumes?")
...
### What if I run out of funds?[​](#what-if-i-run-out-of-funds "Direct link to What if I run out of funds?")
...
### What if the machine that my Pod is running loses power?[​](#what-if-the-machine-that-my-pod-is-running-loses-power "Direct link to What if the machine that my Pod is running loses power?")
...
### What if my Pod loses internet connectivity?[​](#what-if-my-pod-loses-internet-connectivity "Direct link to What if my Pod loses internet connectivity?")
...
### What if it says that my spending limit has been exceeded?[​](#what-if-it-says-that-my-spending-limit-has-been-exceeded "Direct link to What if it says that my spending limit has been exceeded?")
...
## Legal[​](#legal "Direct link to Legal")

***

### Do you have some legal stuff I can look at?[​](#do-you-have-some-legal-stuff-i-can-look-at "Direct link to Do you have some legal stuff I can look at?")
...
### Is RunPod compliant with GDPR for data processed in Europe?[​](#is-runpod-compliant-with-gdpr-for-data-processed-in-europe "Direct link to Is RunPod compliant with GDPR for data processed in Europe?")
...
### What measures does RunPod take to ensure GDPR compliance?[​](#what-measures-does-runpod-take-to-ensure-gdpr-compliance "Direct link to What measures does RunPod take to ensure GDPR compliance?")
...
[Edit this page](https://github.com/runpod/docs/blob/main/docs/references/faq/faq.md)
